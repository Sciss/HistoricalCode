 ...
 *		06-Jul-08	adapted from SwingOSC's EnvelopeView
 */
...
//			SwingOSC.printException( ex, "sendDirtyValues" );
			printException( ex, "sendDirtyValues" );
		}
	}

	private static void printException( Throwable e, String opName )
	{
