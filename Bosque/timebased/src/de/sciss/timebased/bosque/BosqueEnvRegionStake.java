...
//		System.out.println( " YOOOO " + t + "; "+ e.getSource() + "; " + e.getAffectedSpan().shift( span.start ));
	...
	{
		return new ForestEnvRegionStake( this );
	}
...
//	}
	...
	public Stake replaceStart( long newStart )
	{
		...
		return new ForestEnvRegionStake( spanNew, name, track, colr, fadeIn, fadeOut, gain, envNew );
	}
	...
	{
		return new ForestEnvRegionStake( span.shift( delta ), name, track, colr, fadeIn, fadeOut, gain, getEnvCopy() );
	}
}
