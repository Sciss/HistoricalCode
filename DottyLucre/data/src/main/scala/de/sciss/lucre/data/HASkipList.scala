...
import de.sciss.lucre.stm.{Base, Ident, NewImmutSerializer, Sink, TxSerializer, Exec, Var}
...
object HASkipList {
  ...
  private sealed trait Impl[T <: Exec[T], /* @spec(KeySpec) */ A, E]
  ...
  trait Map[T <: Exec[T], /* @spec(KeySpec) */ A, /* @spec(ValueSpec) */ B]
